    ...
    <section class="page-banner" style="background-image:url({{ asset('assets-landing/images/resources/banner.jpg') }});">
        <div class="container">
            ...
            <ul class="breadcumb">
                ...
                <li><a href="{{ route('kegiatan') }}">Kegiatan</a><i class="fa fa-chevron-right" aria-hidden="true"></i></li>
                <li><a class="active" href="#">Detail Kegiatan</a></li>
            </ul>
        </div>
    </section>
    <!--End page-banner-->
                        ...
                        <div class="post-inner">
                            <div class="image-box">
                                <figure><a href="#"><img loading="lazy"
                                            src="{{ asset('/public/kegiatan/' . $data->banner) }}" alt=""></a>
                                </figure>
                            </div>
                            <div class="post-header">
                                <h3>{{ $data->nama_kegiatan }}</h3>
                                <ul class="post-info">
                                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> {{ $data->waktu }}</li>
                                    <li><i class="fa fa-calendar" aria-hidden="true"></i> {{ $data->tanggal }}</li>
                                </ul>
                            </div>
                            <div class="post-desc">
                                <div class="text">
                                ...
                                <div class="single-news">
                                    <figure class="image-holder">
                                        <a href="#"><img loading="lazy"
                                                src="{{ asset('/public/kegiatan/' . $k->banner) }}"></a>
                                    </figure>
                                    <div class="text">
                                        <h4><a
                                                href="{{ route('detail-berita', ['params' => $k->slug]) }}">{{ $k->nama_kegiatan }}</a>
                                        </h4>
                                        <p class="d-flex align-items-center" style="gap: 10px"><span><i
                                                    class="fa fa-clock-o" aria-hidden="true"></i>{{ $k->waktu }}</span>
