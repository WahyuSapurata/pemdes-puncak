...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            window.location.href = '/admin/berita-edit/' + $(this).attr('data-uuid');
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/berita-delete/' + $(this).attr('data-uuid');
                ...
                columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        result =
                            `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/public/berita/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/public/berita/${data}')">
                                    </div>
                                    <!--end::Image-->
