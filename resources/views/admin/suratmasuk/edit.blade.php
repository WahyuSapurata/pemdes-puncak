                            ...
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" id="pengirim" class="form-control" name="pengirim"
                                        value="{{ $data->pengirim }}">
                                    <small class="text-danger pengirim_error"></small>
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" id="tanggal_surat" class="form-control kt_datepicker_7"
                                        name="tanggal_surat" value="{{ $data->tanggal_surat }}">
                                    <small class="text-danger tanggal_surat_error"></small>
                                </div>

                                <div class="mb-10">
                                    <label class="form-label">Tanggal Diterima</label>
                                    <input type="text" id="tanggal_diterima" class="form-control kt_datepicker_7"
                                        name="tanggal_diterima" value="{{ $data->tanggal_diterima }}">
                                    <small class="text-danger tanggal_diterima_error"></small>
                                </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/surat/surat-masuk-update/' + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            ...
                            .then(function() {
                                window.location.href = '/admin/surat/surat-masuk';
                            });
                    } else {
                        $("form")[0].reset();
