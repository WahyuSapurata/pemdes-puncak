                                ...
                                <table id="kt_table_data"
                                    ...
                                    <thead class="text-center">
                                        <tr class="fw-bolder fs-6 text-gray-800">
                                            ...
                                            <th>Perempuan Bekerja</th>
                                            <th>Akses Air Bersih</th>
                                            <th>Listrik</th>
                                            <th>Pekerjaan Layak</th>
                                            <th>Akses Internet</th>
                                            <th>Disabilitas</th>
                                            <th>Rumah Layak</th>
                                            <th>Pengelolaan Sampah</th>
                                            <th>Terdampak Bencana</th>
                                            <th>Pelestari Lingkungan</th>
                                            <th>Ikut Musyawarah</th>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="miskin" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger miskin_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Akses Pangan</label>
                        <select name="akses_pangan" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger akses_pangan_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger bpjs_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Difabel</label>
                        <select name="difabel" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger difabel_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        <label class="form-label">Perempuan Bekerja</label>
                        <select name="perempuan_bekerja" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger perempuan_bekerja_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Akses Air Bersih</label>
                        <select name="akses_air_bersih" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ada</option>
                            <option value="0">Tidak Ada</option>
                        </select>
                        <small class="text-danger akses_air_bersih_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger listrik_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Pekerjaan Layak</label>
                        <select name="pekerjaan_layak" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger pekerjaan_layak_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Akses Internet</label>
                        <select name="akses_internet" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ada</option>
                            <option value="0">Tidak Ada</option>
                        </select>
                        <small class="text-danger akses_internet_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger disabilitas_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Rumah Layak</label>
                        <select name="rumah_layak" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Layak</option>
                            <option value="0">Tidak Layak</option>
                        </select>
                        <small class="text-danger rumah_layak_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Pengelolaan Sampah</label>
                        <select name="pengelolaan_sampah" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Dikelola</option>
                            <option value="0">Tidak Dikelola</option>
                        </select>
                        <small class="text-danger pengelolaan_sampah_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Terdampak Bencana</label>
                        <select name="terdampak_bencana" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger terdampak_bencana_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Pelestari Lingkungan</label>
                        <select name="pelestari_lingkungan" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Aktif</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger pelestari_lingkungan_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Ikut Musyawarah</label>
                        <select name="ikut_musyawarah" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ikut</option>
                            <option value="0">Tidak Ikut</option>
                        </select>
                        <small class="text-danger ikut_musyawarah_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Ikut Organisasi</label>
                        <select name="ikut_organisasi" class="form-control">
                            <option value="">-- Pilih --</option>
                            <option value="1">Ya</option>
                            <option value="0">Tidak</option>
                        </select>
                        <small class="text-danger ikut_organisasi_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'SDGs');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/infografis/sdgs-add', 'Tambah',
                    'SDGs',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/infografis/sdgs-update/' + uuid,
                    'Update',
                    'SDGs', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/infografis/sdgs-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'SDGs', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/infografis/sdgs-delete/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/infografis/sdgs-get',
                columns: [{
                        data: null,
                        ...
                        data: 'terdampak_bencana',
                        className: 'text-center',
                    }, {
                        data: 'pelestari_lingkungan',
                        className: 'text-center',
                    }, {
                        data: 'ikut_musyawarah',
                        className: 'text-center',
                    }, {
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="SDGs" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        function dataSDGs(element) {
            $.ajax({
                url: '/admin/infografis/penduduk-get',
                method: "GET",
                success: function(res) {
                    $(element).html("");
                    let html = "<option selected disabled>Pilih NIK</option>";
