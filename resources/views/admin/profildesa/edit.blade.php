                        ...
                        <div class="card-body hover-scroll-overlay-y">
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea id="sejarah" name="sejarah" value="{{ $data->sejarah }}">{{ $data->sejarah }}</textarea>
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea id="wilayah" name="wilayah" value="{{ $data->wilayah }}">{{ $data->wilayah }}</textarea>
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/profildesa/{{ $data->struktur_organisasi }})">
...
@section('script')
    ...
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/profil-desa-update/' + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            .fire({
                                text: `Profil desa berhasil di Edit`,
                                icon: "success",
