                ...
                columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if (row.tanggal_mulai && row.tanggal_selesai) {
                            result = `${row.tanggal_mulai} - ${row.tanggal_selesai}`;
                        } else if (row.tanggal_mulai) {
                            result = row.tanggal_mulai;
                        } else if (row.tanggal_selesai) {
                            result = row.tanggal_selesai;
                        } else {
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            <div class="d-flex gap-2" style="flex-flow: wrap;">
                                ...
                                <a href="javascript:;" type="button" data-uuid="${data}" data-label="${full.status == 'nonaktif' ? 'Buka' : 'Tutup'}" class="btn btn-success button-action btn-sm">
                                    ${full.status == 'nonaktif' ? 'Aktivkan' : 'Non Aktivkan'}
                                </a>
                            </div>
                        `;
                    },
