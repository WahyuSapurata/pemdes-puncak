                            ...
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/strukturdesa/{{ $data->foto }})">
                                        ...
                                        <label
                                            ...
                                            data-bs-dismiss="click" title="Change Foto">
                                        ...
                                        <span
                                            ...
                                            data-bs-dismiss="click" title="Cancel Foto">
                                        ...
                                        <span
                                            ...
                                            data-bs-dismiss="click" title="Remove Foto">
                                            <i class="bi bi-x fs-2"></i>
                                        </span>
                                        <!--end::Remove button-->
                                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/struktur-desa-update/' + lastPart,
                ...
                success: function(response) {
                    ...
                    if (response.success == true) {
                        swal
                            .fire({
                                text: `Struktur desa berhasil di Edit`,
                                icon: "success",
                                showConfirmButton: false,
                                timer: 1500,
                            })
                            .then(function() {
                                window.location.href = '/admin/struktur-desa';
                            });
                    } else {
                        $("form")[0].reset();
