    ...
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'update') {
                ...
                control.submitFormMultipartData('/admin/surat/surat-pengajuan-update/' + uuid,
                    'Update',
                    'Surat Pengajuan', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/surat/surat-pengajuan-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Surat Pengajuan', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/surat/surat-pengajuan-delete/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async (year) => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/surat/surat-pengajuan-get',
                columns: [{
                        data: null,
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            result =
                                `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/public/pengajuan/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/public/pengajuan/${data}')">
                                    </div>
                                    <!--end::Image-->
                        ...
                        render: function(data, type, row, meta) {
                            const value =
                                `
                                    <a href="javascript:;" type="button" class="btn ${data == 'proses' ? 'btn-info' : data == 'setujui' ? 'btn-success' : data == 'tolak' ? 'btn-danger' : ''} btn-sm">
                                        ${data}
                                    </a>
                                `;
                            return value;
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Surat Pengajuan" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/admin/infografis/surat-pengajuan-export`, "_blank");
        // });
    </script>
@endsection
