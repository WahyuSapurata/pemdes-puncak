        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        <label class="form-label">Jenis Peristiwa</label>
                        ...
                        <small class="text-danger jenis_peristiwa_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Tanggal Peristiwa</label>
                        <input type="text" id="tanggal_peristiwa" class="form-control" name="tanggal_peristiwa">
                        <small class="text-danger tanggal_peristiwa_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Riwayat Penduduk');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/infografis/riwayat-penduduk-add', 'Tambah',
                    'Riwayat Penduduk',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/infografis/riwayat-penduduk-update/' + uuid,
                    'Update',
                    'Riwayat Penduduk', 'POST');
            }
        });

        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/infografis/riwayat-penduduk-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Riwayat Penduduk', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/infografis/riwayat-penduduk-delete/' + $(this).attr('data-uuid');
            let label = $(this).attr('data-label');
            control.ajaxDelete(url, label)
        })

        $("#tanggal_peristiwa").flatpickr({
            altInput: true,
            altFormat: "d-m-Y",
            dateFormat: "d-m-Y",
        });
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/admin/infografis/riwayat-penduduk-get',
                columns: [{
                        data: null,
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Riwayat Penduduk" class="btn btn-danger button-delete btn-icon btn-sm">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/admin/infografis/riwayat-penduduk-export`, "_blank");
        // });
    </script>
@endsection
