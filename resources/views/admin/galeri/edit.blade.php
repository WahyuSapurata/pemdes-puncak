                            ...
                            <form class="form-data" enctype="multipart/form-data">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="image-input image-input-empty" data-kt-image-input="true"
                                        style="background-image: url(/public/galeri/{{ $data->gambar }})">
                                        ...
                                        <label
                                            ...
                                            data-bs-dismiss="click" title="Change Gambar">
                                        ...
                                        <span
                                            ...
                                            data-bs-dismiss="click" title="Cancel Gambar">
                                        ...
                                        <span
                                            ...
                                            data-bs-dismiss="click" title="Remove Gambar">
                                            <i class="bi bi-x fs-2"></i>
                                        </span>
                                        <!--end::Remove button-->
                                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/galeri-update/' + lastPart,
