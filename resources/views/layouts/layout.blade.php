...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('logo-sinjai.png') }}" />
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <!--begin::Brand-->
                <div class="aside-logo flex-column-auto" style="background-color: #045126;">
                        ...
                        <a href="" class="full-logo">
                            <div class="app-sidebar-logo-default">
                                <div class="d-flex align-items-center gap-3 justify-content-center">
                                    <img alt="Logo" src="{{ asset('logo-sinjai.png') }}" class="h-50px" />
                                    <div
                                        style="color: #ffffff; font-size: 20px; line-height: 19px; font-weight: bold; font-style: italic;">
                                        Pemdes <br> Puncak</div>
                                </div>
                            </div>
                            <div class="app-sidebar-logo-minimize">
                                <div class="d-flex align-items-center">
                                    <img alt="Logo" src="{{ asset('logo-sinjai.png') }}" class="h-35px" />
                                </div>
                            </div>
                        </a>
                    </div>
